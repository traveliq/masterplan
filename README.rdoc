...
the rules as a Schemer::Document, and validate the data while it's still Ruby, and say that as long
...
that is easily forgotten. If you have a schemer document, you can use it not only as the template,
...
Martin Tepper (monogreen.de), Holger Pillmann
